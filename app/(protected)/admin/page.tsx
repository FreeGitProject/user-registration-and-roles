...
export default function AdminDashboardPage() {
  ...
  const uniqueUsers = new Set(orders.map((o) => o.userId?.toString())).size
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {pendingOrders + processingOrders} need attention
            </p>
          </CardContent>
        </Card>
        <Card>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {recentOrders.length > 0 ? "Latest orders from customers" : "No orders yet"}
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {products.length > 0 ? "Your product inventory" : "No products yet"}
            </CardDescription>
          </CardHeader>
          <CardContent>
            {products.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <Link href="/admin/products" className="text-sm text-primary hover:underline mt-2">
              ...
              <div className="space-y-4">
                {products.slice(0, 5).map((product, index) => (
                  <div key={product._id?.toString()} className="flex items-center justify-between border-b pb-4 last:border-0 last:pb-0">
